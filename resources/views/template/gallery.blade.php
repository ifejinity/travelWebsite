                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/delicacies/san-felipe-bagnet.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/delicacies/zambales-mango.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/delicacies/ginipang.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/delicacies/pastillas.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/delicacies/linga.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                ...
                <div class="w-full lg:w-[75%]">
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/festivals/dinamulag.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/festivals/sibit-sibit.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/festivals/paynauen.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/festivals/domorokdok.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/festivals/grand-mardi-gras.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/festivals/karakoa.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover modalItems"/></figure>
                                    <div class="card-body">
