...
@section('destinations')
    <div class="flex md:flex-row flex-col min-h-fit justify-center my-[100px] gap-5 relative pt-[30px]" id="destinations"> 
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/anawangin.JPG') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/nagsasa.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/capones-island.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/crystal-beach.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/inflatable-island.jpeg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/mt-pinatubo.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/talisayen.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/camara-island.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/el-kabayo.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/rosa-farms.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/ramon-magsaysay-museum.JPG') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/botolan-wildlife-farm.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                ...
                <div class="w-full lg:w-[75%]">
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/sunset-villas.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/acme.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/palms-resort.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/villa-janella.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/lazerena.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/whiterock.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/segara.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/central-park-reef.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/casa-saudade.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/oyo.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/subic-bay-view.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/youhan.jpg') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                ...
                <div class="w-full lg:w-[75%]">
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/agoho-restaurant.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/sestra-liwa.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/kwentong-dagat.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/taco-joint.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/cafe-de-liwa.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/sunday-liwa.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/kapitan-liwa.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide pb-10 w-fit">
                                <div class="card card-compact max-w-[350px] rounded-none">
                                    <figure><img src="{{ asset('assets/images/destinations/seazzle-spot.webp') }}" alt="" class="w-full max-w-[350px] h-[250px] object-cover imgDestination"/></figure>
                                    <div class="card-body">
