...
<body style="background-color: #f7f5fa; margin: 0 !important; padding: 0 !important;">
    ...
    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="480" >
            ...
            <td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
                <div style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0">DiscoverZambales</div>
            </td>
            </tr>
        </table>
        </td>
    ...
    <tr>
        <td bgcolor="#3b82f6" align="center" style="padding: 0px 10px 0px 10px;">
        <table border="0" cellpadding="0" cellspacing="0" width="480" >
            <tr>
            <td bgcolor="#ffffff" align="left" valign="top" style="padding: 30px 30px 20px 30px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; line-height: 48px;">
                <h1 style="font-size: 32px; font-weight: 400; margin: 0;">Email</h1>
            </td>
            </tr>
        </table>
        </td>
            ...
            <td bgcolor="#ffffff" align="left">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" style="padding-left:15px;padding-right:30px;padding-bottom:10px;font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">{{ $fromEmail }}</td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" valign="top" style="padding-left:15px;padding-right:30px;padding-bottom:10px;font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">{{ $fromName }}</td>
                    </tr>
                </table>
            </td>
            </tr>
            ...
            <td bgcolor="#ffffff" align="center">
                ...
                <tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        <td align="left" style="border-radius: 3px;" bgcolor="#3b82f6">
                            <a href="mailto:{{ $fromEmail }}" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 11px 22px; border-radius: 2px; border: 1px solid #3b82f6; display: inline-block;">Reply</a>
                        </td>
                        </tr>
                    </table>
                    </td>
    ...
    <tr>
        ...
        <tr>
            ...
            <p style="margin: 0;">For more inquiries email us on "<a href="mailto:mrlonzanida08@gmail.com" target="_blank" style="color: #111111; font-weight: 700;">mrlonzanida08@gmail.com<a>".</p>
            </td>
        </tr>
        </td>
    </tr>
